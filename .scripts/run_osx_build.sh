...
validate_recipe_outputs "tensorflow-estimator-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="tensorflow-estimator-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi